...
MM_CORE_TARGET = 8909
else ifeq ($(PRODUCT_BOARD_PLATFORM),msm8937)
MM_CORE_TARGET = 8937
...
else ifeq ($(PRODUCT_BOARD_PLATFORM),msm8996)
MM_CORE_TARGET = msm8996
else ifeq ($(PRODUCT_BOARD_PLATFORM),msm8952)
MM_CORE_TARGET = 8952
else ifeq ($(PRODUCT_BOARD_PLATFORM),msm8953)
MM_CORE_TARGET = msm8953
else ifeq ($(PRODUCT_BOARD_PLATFORM),msm8998)
MM_CORE_TARGET = msm8998
else ifeq ($(PRODUCT_BOARD_PLATFORM),apq8098_latv)
MM_CORE_TARGET = msm8998
else ifeq ($(PRODUCT_BOARD_PLATFORM),sdm660)
...
ifneq (,$(filter msm8916 msm8994 msm8909 msm8937 msm8996 msm8992 msm8952 msm8953 msm8998 apq8098_latv sdm660,$(PRODUCT_BOARD_PLATFORM)))
